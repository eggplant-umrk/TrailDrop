  ...
  return [
    {
      ...
      description: "鮎の甘露煮を燻製にした、七宗食品の川魚のお土産。",
      category: "川魚・燻製",
      content_amount: "100g",
      storage_method: "常温。直射日光・高温多湿を避け、冷暗所で保存。",
      source_url: "https://hida-seiryu.com/product/kunsei/kb0220010/",
    ...
    },
    {
      ...
      title: "若鶏の皮肝けいちゃん 200g×2袋",
      type: "pickup",
      price: 900,
      stock: 8,
      shop_id: "b2222222-2222-4222-8222-222222222222",
      description: "岐阜県産若鶏の皮・砂肝・心臓などを米麹味噌で味付け。",
      category: "けいちゃん",
      content_amount: "200g×2袋",
      storage_method: "冷凍。受取までの保冷方法を確認。",
      source_url: "https://www.furusato-tax.jp/product/detail/21504/7117947",
      price_note: "デモ用設定価格。提供者の販売価格ではありません。",
      is_active: true,
      location_name: "道の駅 ロック・ガーデンひちそう",
      pickup_available_from: "07:00:00",
    ...
    },
    {
      ...
      title: "東濃ひのき薪 20kg×1箱 皮つき",
      type: "pickup",
      price: 2800,
      stock: 2,
      shop_id: "b3333333-3333-4333-8333-333333333333",
      description: "七宗町の森林資源を活用した、自然乾燥の東濃ヒノキ薪。",
      category: "森林・薪",
      content_amount: "20kg×1箱",
      storage_method: "常温。天然材料のため虫・カビに注意。",
      source_url: "https://www.furusato-tax.jp/product/detail/21504/7211223",
      price_note: "デモ用設定価格。提供者の販売価格ではありません。",
      is_active: true,
      location_name: "道の駅 ロック・ガーデンひちそう",
      pickup_available_from: "07:00:00",
    ...
    },
    {
      ...
      storage_method: "要冷蔵。賞味期限は製造日を含め5日。",
      source_url: "https://hida-seiryu.com/product/kunsei/kb0220033/",
      price_note: "デモ用設定価格。提供者の販売価格ではありません。",
      is_active: true,
      location_name: "道の駅 ロック・ガーデンひちそう",
      pickup_available_from: "07:00:00",
    ...
    },
    {
      ...
      title: "菊泉本舗 特選 お茶せんべい 26枚入り",
      type: "pickup",
      price: 700,
      stock: 12,
      shop_id: "b4444444-4444-4444-8444-444444444444",
      description: "七宗町の菊泉本舗が扱う、お茶の風味を楽しめるせんべい。",
      category: "茶菓子",
      content_amount: "26枚",
      storage_method: "保存方法は現物表示を確認。",
      source_url: "https://furusato.saisoncard.co.jp/products/detail.php?product_id=328660",
      price_note: "デモ用設定価格。提供者の販売価格ではありません。",
      is_active: true,
      location_name: "道の駅 ロック・ガーデンひちそう",
      pickup_available_from: "07:00:00",
